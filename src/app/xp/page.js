...
const Page = () => {
  return (
    ...
    <Swiper />
    <h2 class="text-2xl font-bold border-b border-gray-700 pb-2 mb-4">ABOUT THIS PROJECT</h2>
    ...
    <ul class="list-none mb-4">
        <li class="pl-4 mb-2 relative before:content-['•'] before:absolute before:left-0 before:text-white before:font-bold">Logo Designer</li>
    </ul>
