...
import { SparklesCore } from "@/app/components/ui/sparkless";
  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          <stop stopColor="#7541EE" stopOpacity="0" />
          <stop stopColor="#7541EE" />
          <stop offset="1" stopColor="#7541EE" stopOpacity="0" />
        </motion.linearGradient>
      </defs>
    </motion.svg>
  );
